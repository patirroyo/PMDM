...
@NamedQueries({
    ...
    , @NamedQuery(name = "Proyecto.findBySede", query = "SELECT p FROM Proyecto p WHERE p.sede = :sede")
    ...
    , @NamedQuery(name = "Proyecto.findByTipoEntidad", query = "SELECT p FROM Proyecto p WHERE p.tipoEntidad = :tipoEntidad")
    ...
    , @NamedQuery(name = "Proyecto.findBySectorMS", query = "SELECT p FROM Proyecto p WHERE p.sectorMS = :sectorMS")
    , @NamedQuery(name = "Proyecto.findBySubsectorMS", query = "SELECT p FROM Proyecto p WHERE p.subsectorMS = :subsectorMS")
    ...
    , @NamedQuery(name = "Proyecto.findByTecFor", query = "SELECT p FROM Proyecto p WHERE p.tecFor = :tecFor")
    , @NamedQuery(name = "Proyecto.findByTecSeg", query = "SELECT p FROM Proyecto p WHERE p.tecSeg = :tecSeg")
...
public class Proyecto implements Serializable {
    ...
    @Column(name = "sectorMS")
    private Integer sectorMS;
    @Column(name = "subsectorMS")
    private Integer subsectorMS;
    @Size(max = 3)
    ...
    @Column(name = "tec_for")
    private Integer tecFor;
    @Column(name = "tec_seg")
    private Integer tecSeg;
    @Lob
    @Size(max = 2147483647)
    ...
    public String getInspectoria() {
        return inspectoria;
    }

    public void setInspectoria(String inspectoria) {
    ...
    public Integer getSectorMS() {
        return sectorMS;
    }

    public void setSectorMS(Integer sectorMS) {
        this.sectorMS = sectorMS;
    }

    public Integer getSubsectorMS() {
        return subsectorMS;
    }

    public void setSubsectorMS(Integer subsectorMS) {
    ...
    public Integer getTecFor() {
        return tecFor;
    }

    public void setTecFor(Integer tecFor) {
        this.tecFor = tecFor;
    }

    public Integer getTecSeg() {
        return tecSeg;
    }

    public void setTecSeg(Integer tecSeg) {
        this.tecSeg = tecSeg;
    }
