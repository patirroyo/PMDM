export interface IProfesor {//Esto es una interfaz que sirve para definir los atributos de un objeto, en este caso de un alumno
    id: number;
    nombre: string;
    apellidos: string;
    direccion: string;
...
export class Profesor implements IProfesor {//Esto es una clase que sirve para crear objetos de tipo alumno
